...
* Add the connection parameters in the `coop-monitor.db.core` namespace.
...
Request middleware functions are located under the `coop-monitor.middleware` namespace.
